...
cd('/home/amathew/remote_path/eeglab2023.1/');
eeglab;
...
BeforePreprocessing = '/home/amathew/remote_path/1-BeforePreprocessing/';
cd(BeforePreprocessing);

% Create root folder to store new preprocessed .set files
AfterPreprocessing = '/home/amathew/remote_path/2-AfterPreprocessing/';
...
for num = 1:length(SubjectFolders)
    ...
    for i = 1:length(MFF_Files)
        ...
        Output_FileName = append(FileName(1:end-4), '_Oct2.set');
...
%         EEG = eeg_checkset(EEG);
    ...
    disp(append('Preprocessing complete for all datasets for ', Subject_Num));
end
